<template>
  <div class="briefing-tab">
    ...
    <div class="intel-briefing glass-xs" v-if="hasEvals && !isSynthesizing">
    ...
    <!-- Synthesis Progress (already handled in parent) -->
    <slot />
  </div>
</template>
...
<style scoped>
.briefing-tab { display: flex; flex-direction: column; gap: var(--space-4); }
</style>
