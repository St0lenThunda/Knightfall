    ...
    <template v-else>
      <div class="lab-content">
        ...
        <div v-if="openingRx.length > 0" class="rx-section mb-8">
          ...
          <div class="rx-strip">
            <div v-for="rx in openingRx" :key="rx.title" class="rx-card glass-card" :class="'rx-' + rx.severity">
        ...
        <div v-if="selectedCategory === 'repertoire'" class="repertoire-grid">
          ...
          <div v-else v-for="opening in detectedOpenings" :key="opening.id" class="opening-card glass-card">
            ...
            <div class="card-actions">
              <button class="btn btn-ghost btn-sm w-full" @click="startTraining(opening.id)">Train Tactics</button>
            </div>
          </div>
        </div>
        <!-- Curated Section -->
