...
export const useCurriculumStore = defineStore('curriculum', () => {
  ...
  const quests = ref<Quest[]>([
    ...
    { id: 'grandmaster-peak', title: 'The Peak', category: 'Tactics', requirements: ['slav-defense'], icon: '⛰️', status: 'locked', xp_reward: 250, questType: 'trial', realmId: 'tactics-realm' , description: "This is the ultimate test. You will face a grueling sequence of Master-level tactical puzzles combining pins, deflections, sacrifices, and deep calculation. Only the worthy will conquer The Peak." },

    // ─── ADDED CURRICULUM EXPANSION: 15 NEW TRIAL QUESTS ───

    // --- Tactics Expansion ---
    { id: 'deflection-101', title: 'Tactics: Deflection', category: 'Tactics', requirements: ['greek-gift'], icon: '🎯', status: 'locked', xp_reward: 60, questType: 'trial', realmId: 'tactics-realm', description: "Deflection is a tactic that forces an opponent's piece away from a square it defends, leaving key targets exposed. By distracting a vital defender, you can break the enemy coordination and launch a winning strike." },
    { id: 'clearance-101', title: 'Tactics: Clearance', category: 'Tactics', requirements: ['deflection-101'], icon: '🧹', status: 'locked', xp_reward: 70, questType: 'trial', realmId: 'tactics-realm', description: "A clearance sacrifice involves giving up a piece to open up a critical line or square for another attacking piece to move in. Clearing the path allows your remaining forces to coordinate with maximum efficiency." },
    { id: 'windmill-101', title: 'Tactics: Windmill', category: 'Tactics', requirements: ['clearance-101'], icon: '🌀', status: 'locked', xp_reward: 80, questType: 'trial', realmId: 'tactics-realm', description: "The windmill (or see-saw) is a rare but devastating tactical combination featuring a repeating sequence of checks and discovered checks. The opponent is helpless as your active pieces sweep the board." },
    { id: 'double-check-101', title: 'Tactics: Double Check', category: 'Tactics', requirements: ['windmill-101'], icon: '🎯⚡', status: 'locked', xp_reward: 60, questType: 'trial', realmId: 'tactics-realm', description: "A double check occurs when the king is attacked by two pieces simultaneously. Since you cannot block both attacks or capture both attackers at once, the king is forced to move, often leading to immediate checkmate." },

    // --- Strategy / Positional Expansion ---
    { id: 'weak-pawns-101', title: 'Position: Weak Pawns', category: 'Positional', requirements: ['outposts-201'], icon: '🩹', status: 'locked', xp_reward: 65, questType: 'trial', realmId: 'strategy-realm', description: "Backward and isolated pawns cannot be protected by fellow pawns. Learning to identify these structural targets, fix them in place, and apply crushing pressure is a fundamental pillar of strategic mastery." },
    { id: 'open-files-101', title: 'Position: Open Files', category: 'Positional', requirements: ['weak-pawns-101'], icon: '🛣️', status: 'locked', xp_reward: 50, questType: 'trial', realmId: 'strategy-realm', description: "Open files are vertical highways for your rooks and queens. Controlling these lines allows you to penetrate deep into the opponent's camp, targeting weak back ranks and establishing seventh-rank rooks." },
    { id: 'minor-pieces-101', title: 'Position: Minor Pieces', category: 'Positional', requirements: ['open-files-101'], icon: '⚖️', status: 'locked', xp_reward: 70, questType: 'trial', realmId: 'strategy-realm', description: "Not all minor pieces are created equal. You will learn to recognize when a bishop is 'bad' (restricted by its own pawns) or when a knight is 'good' (occupying a permanent outpost), and trade pieces to achieve positional superiority." },
    { id: 'space-advantage-101', title: 'Position: Space', category: 'Positional', requirements: ['minor-pieces-101'], icon: '🌌', status: 'locked', xp_reward: 75, questType: 'trial', realmId: 'strategy-realm', description: "A space advantage restricts your opponent's piece mobility, forcing them into passive and cramped defensive squares. By claiming more territory with your pawns, you squeeze the opponent out of options." },

    // --- Endgame Expansion ---
    { id: 'king-activity-101', title: 'Endgame: King Activity', category: 'Endgame', requirements: ['opposition-201'], icon: '👑🏃', status: 'locked', xp_reward: 55, questType: 'trial', realmId: 'endgame-realm', description: "When the heavy pieces are traded off, the King must shed its defensive role and march into battle. An active King is the most powerful piece in the endgame, leading the charge to support passed pawns." },
    { id: 'zugzwang-101', title: 'Endgame: Zugzwang', category: 'Endgame', requirements: ['king-activity-101'], icon: '⛓️', status: 'locked', xp_reward: 70, questType: 'trial', realmId: 'endgame-realm', description: "Zugzwang is a German term meaning 'compulsion to move'. It describes a position where having to make any move weakens the player's position. Master the art of passing the turn to force your opponent into defeat." },
    { id: 'triangulation-101', title: 'Endgame: Triangulation', category: 'Endgame', requirements: ['zugzwang-101'], icon: '🔺', status: 'locked', xp_reward: 80, questType: 'trial', realmId: 'endgame-realm', description: "Triangulation is a key geometric technique used to lose a tempo. By maneuvering your king in a triangular path while your opponent is locked in a direct path, you force them into a devastating zugzwang." },
    { id: 'opposite-bishops-101', title: 'Endgame: Opposite Bishops', category: 'Endgame', requirements: ['triangulation-101'], icon: '☯️', status: 'locked', xp_reward: 65, questType: 'trial', realmId: 'endgame-realm', description: "Endgames with opposite-colored bishops are notoriously drawish. You will learn the defensive rules to establish unbreakable blockades, as well as the active techniques to break through the opponent's colors." },

    // --- Opening Expansion ---
    { id: 'queens-gambit', title: 'Opening: Queen\'s Gambit', category: 'Opening', requirements: ['ruy-lopez'], icon: '♕', status: 'locked', xp_reward: 60, questType: 'trial', realmId: 'opening-realm', description: "The Queen's Gambit (1.d4 d5 2.c4) is a classical opening where White offers a wing pawn to gain control of the center. You will explore the main structures in both the Accepted and Declined variations." },
    { id: 'kings-indian', title: 'Opening: King\'s Indian', category: 'Opening', requirements: ['queens-gambit'], icon: '🏰🛡️', status: 'locked', xp_reward: 70, questType: 'trial', realmId: 'opening-realm', description: "The King's Indian Defense is a hypermodern setup where Black allows White to build a massive pawn center, only to strike back with flanking pawn breaks. It leads to sharp, double-edged king attacks on both sides." },
    { id: 'flank-openings', title: 'Opening: Flank Openings', category: 'Opening', requirements: ['kings-indian'], icon: '🏹', status: 'locked', xp_reward: 65, questType: 'trial', realmId: 'opening-realm', description: "Flank openings like the Reti (1.Nf3) or English (1.c4) exert pressure on the center from the wings. By delaying central pawn pushes, you keep the position flexible and prepare to exploit weak squares." },

    // ─── ADDED CURRICULUM EXPANSION: 25 ADDITIONAL TRIAL QUESTS (5,000 XP TOTAL) ───

    // --- Advanced Tactics (480 XP) ---
    { id: 'desperado-101', title: 'Tactics: Desperado', category: 'Tactics', requirements: ['double-check-101'], icon: '💥', status: 'locked', xp_reward: 80, questType: 'trial', realmId: 'tactics-realm', description: "A desperado is a tactical situation where a piece that is already trapped or doomed executes a capture or check to maximize its value before it is lost." },
    { id: 'underpromotion-101', title: 'Tactics: Underpromotion', category: 'Tactics', requirements: ['desperado-101'], icon: '♟️👑', status: 'locked', xp_reward: 80, questType: 'trial', realmId: 'tactics-realm', description: "Underpromotion is promoting a pawn to a knight, bishop, or rook instead of a queen, typically to avoid immediate stalemate or execute a critical winning check." },
    { id: 'stalemate-combo', title: 'Tactics: Stalemate Combos', category: 'Tactics', requirements: ['underpromotion-101'], icon: '🏳️', status: 'locked', xp_reward: 80, questType: 'trial', realmId: 'tactics-realm', description: "Stalemate combinations are defensive strategies to force a draw in a lost position by sacrificing your remaining active pieces until your King has no legal moves." },
    { id: 'deflection-guards', title: 'Tactics: Deflecting Guard', category: 'Tactics', requirements: ['stalemate-combo'], icon: '🎯🛡️', status: 'locked', xp_reward: 80, questType: 'trial', realmId: 'tactics-realm', description: "This tactical pattern deflects the opponent's defensive guards away from key squares, paving the path for devastating checkmates or heavy material gain." },
    { id: 'overloaded-pieces', title: 'Tactics: Overloaded Pieces', category: 'Tactics', requirements: ['deflection-guards'], icon: '🏋️', status: 'locked', xp_reward: 80, questType: 'trial', realmId: 'tactics-realm', description: "An overloaded piece has too many defensive duties. By attacking one of its protected targets, you force it to abandon its other defense, breaking its coordination." },
    { id: 'king-hunt', title: 'Tactics: The King Hunt', category: 'Tactics', requirements: ['overloaded-pieces'], icon: '📯', status: 'locked', xp_reward: 80, questType: 'trial', realmId: 'tactics-realm', description: "A King Hunt is a tactical sequence where the opponent's king is forced out of safety into the open board and chased down to a checkmate with active coordination." },

    // --- Advanced Positional / Strategy (455 XP) ---
    { id: 'prophylaxis-101', title: 'Position: Prophylaxis', category: 'Positional', requirements: ['space-advantage-101'], icon: '🛡️🧠', status: 'locked', xp_reward: 80, questType: 'trial', realmId: 'strategy-realm', description: "Prophylaxis is the art of anticipating your opponent's active plans and taking preventive measures to stop them before they can start." },
    { id: 'pawn-chains-101', title: 'Position: Pawn Chains', category: 'Positional', requirements: ['prophylaxis-101'], icon: '⛓️♟️', status: 'locked', xp_reward: 80, questType: 'trial', realmId: 'strategy-realm', description: "Pawn chains form rigid barriers. You will learn to attack chains at their base to crumble the structure, or break them at the head to open diagonals." },
    { id: 'hanging-pawns-101', title: 'Position: Hanging Pawns', category: 'Positional', requirements: ['pawn-chains-101'], icon: '⚖️♟️', status: 'locked', xp_reward: 80, questType: 'trial', realmId: 'strategy-realm', description: "Hanging pawns are adjacent pawn pairs on open files. They are extremely dynamic, offering immense space and attacking power, but can become weak targets if blockaded." },
    { id: 'isolani-101', title: 'Position: The Isolani', category: 'Positional', requirements: ['hanging-pawns-101'], icon: '🎯♟️', status: 'locked', xp_reward: 80, questType: 'trial', realmId: 'strategy-realm', description: "The Isolated Queen Pawn (Isolani) offers active piece play and open diagonals, but becomes a long-term endgame liability if the defender blockades the d5 square." },
    { id: 'carlsbad-101', title: 'Position: Carlsbad Structure', category: 'Positional', requirements: ['isolani-101'], icon: '🗺️🏰', status: 'locked', xp_reward: 80, questType: 'trial', realmId: 'strategy-realm', description: "The Carlsbad exchange structure features asymmetry that defines middle game plans, such as White's minority attack on the queenside or central breakthroughs." },
    { id: 'king-safety-mid', title: 'Position: Middlegame Safety', category: 'Positional', requirements: ['carlsbad-101'], icon: '🏰🛡️', status: 'locked', xp_reward: 55, questType: 'trial', realmId: 'strategy-realm', description: "Evaluate the cover of your king's pawn shield, recognize defensive weaknesses, and execute attacks against compromised castled positions." },

    // --- Advanced Endgames (455 XP) ---
    { id: 'lucena-position', title: 'Endgame: Lucena Bridge', category: 'Endgame', requirements: ['opposite-bishops-101'], icon: '🌉', status: 'locked', xp_reward: 80, questType: 'trial', realmId: 'endgame-realm', description: "The Lucena position is the cornerstone of rook endgames. White builds a 'bridge' with their rook on the 4th rank to shield the king from checks and promote the pawn." },
    { id: 'philidor-position', title: 'Endgame: Philidor Draw', category: 'Endgame', requirements: ['lucena-position'], icon: '🧱⏳', status: 'locked', xp_reward: 80, questType: 'trial', realmId: 'endgame-realm', description: "The Philidor position is the fundamental drawing method in rook endgames. Block the king on the 6th rank, then drop back to execute checks from behind." },
    { id: 'vancura-position', title: 'Endgame: Vancura Defense', category: 'Endgame', requirements: ['philidor-position'], icon: '🛡️⏳', status: 'locked', xp_reward: 80, questType: 'trial', realmId: 'endgame-realm', description: "The Vancura position teaches how to draw against a rook and rook-pawn on the 7th rank using side-checks from a safe distance, rendering the pawn unpromotable." },
    { id: 'kp-vs-k', title: 'Endgame: King and Pawn', category: 'Endgame', requirements: ['vancura-position'], icon: '♟️⚖️', status: 'locked', xp_reward: 80, questType: 'trial', realmId: 'endgame-realm', description: "Master key squares, promotion paths, and King positioning to successfully win or draw basic King-and-Pawn endgames." },
    { id: 'queen-vs-pawn', title: 'Endgame: Queen vs Pawn', category: 'Endgame', requirements: ['kp-vs-k'], icon: '👑♟️', status: 'locked', xp_reward: 80, questType: 'trial', realmId: 'endgame-realm', description: "Escort the king to stop passed pawns on the 7th rank, and master the drawing exceptions for rook pawns and bishop pawns." },
    { id: 'knight-vs-bishop', title: 'Endgame: Knight vs Bishop', category: 'Endgame', requirements: ['queen-vs-pawn'], icon: '🐴⛪', status: 'locked', xp_reward: 80, questType: 'trial', realmId: 'endgame-realm', description: "Compare minor pieces in the endgame, exploiting closed blockaded boards for knights versus open two-flanked boards for bishops." },

    // --- Advanced Openings (560 XP) ---
    { id: 'nimzo-indian', title: 'Opening: Nimzo-Indian', category: 'Opening', requirements: ['flank-openings'], icon: '🦅', status: 'locked', xp_reward: 80, questType: 'trial', realmId: 'opening-realm', description: "The Nimzo-Indian Defense (1.d4 Nf6 2.c4 e6 3.Nc3 Bb4) pins the knight on c3 to establish hypermodern control over the central e4 square." },
    { id: 'grunfeld-defense', title: 'Opening: Grunfeld', category: 'Opening', requirements: ['nimzo-indian'], icon: '⚔️🛡️', status: 'locked', xp_reward: 80, questType: 'trial', realmId: 'opening-realm', description: "The Grunfeld Defense (1.d4 Nf6 2.c4 g6 3.Nc3 d5) allows White to establish a massive pawn center, which Black immediately targets with c5 and Bg7." },
    { id: 'scandinavian', title: 'Opening: Scandinavian', category: 'Opening', requirements: ['grunfeld-defense'], icon: '❄️', status: 'locked', xp_reward: 80, questType: 'trial', realmId: 'opening-realm', description: "The Scandinavian Defense (1.e4 d5) immediately strikes the center on move one, leading to open tactical lines and rapid piece activation." },
    { id: 'italian-game', title: 'Opening: Italian Game', category: 'Opening', requirements: ['scandinavian'], icon: '🇮🇹', status: 'locked', xp_reward: 80, questType: 'trial', realmId: 'opening-realm', description: "The Italian Game (1.e4 e5 2.Nf3 Nc6 3.Bc4) is one of the oldest openings, targeting the vulnerable f7 square and preparing rapid castling." },
    { id: 'scotch-game', title: 'Opening: Scotch Game', category: 'Opening', requirements: ['italian-game'], icon: '🏴󠁧󠁢󠁳󠁣󠁴󠁿', status: 'locked', xp_reward: 80, questType: 'trial', realmId: 'opening-realm', description: "The Scotch Game (1.e4 e5 2.Nf3 Nc6 3.d4) breaks open the center on move three, leading to open tactical battles and rapid piece trades." },
    { id: 'kings-gambit-op', title: 'Opening: King\'s Gambit', category: 'Opening', requirements: ['scotch-game'], icon: '📯⚔️', status: 'locked', xp_reward: 80, questType: 'trial', realmId: 'opening-realm', description: "The King's Gambit (1.e4 e5 2.f4) is a romantic, highly tactical opening offering White's f-pawn to establish rapid center control and f-file rooks." },
    { id: 'slav-defense', title: 'Opening: Slav Defense', category: 'Opening', requirements: ['kings-gambit-op'], icon: '🛡️🇷🇺', status: 'locked', xp_reward: 80, questType: 'trial', realmId: 'opening-realm', description: "The Slav Defense (1.d4 d5 2.c4 c6) provides Black with a solid central structure, defending the d5 pawn without blocking the light-squared bishop." },
  ])
    ...
    try {
      ...
      if (!personalPuzzles.value.some(p => p.id === puzzleId)) {
        personalPuzzles.value.unshift({
          id: puzzleId,
          title: severity === 'blunder' ? 'Personal Blunder' : 'Personal Mistake',
          rating: Math.round(1500 - dropInPawns * 100),
          fen: blunderData.fen,
          lastMove: blunderData.playerMove || '',
  ...
  async function generatePersonalPuzzles() {
    ...
    try {
      ...
      personalPuzzles.value = newPuzzles
        .sort((a, b) => {
          const valB = b.severity ? (severityMap[b.severity] || 0) : 0
          const valA = a.severity ? (severityMap[a.severity] || 0) : 0
          return valB - valA
        })
        .slice(0, 15)
